...
if (!empty($_POST)) {
	...
	if (!empty($title)) {
		...
		if ($id == '') {
			...
			$sql = 'update product set title = "'.$title.'",price = "'.$price.'", thumbnail = "'.$thumbnail.'", content = "'.$content.'", id_category = "'.$id_category.'", created_at = "'.$created_at.'", updated_at = "'.$updated_at.'" where id = '.$id;
		}
...
?>
                    ...
                    <div class="form-group">
					  ...
					  <img src = "<?=$thumbnail?>" style = "max-width : 100px" id="img_thumbnail">
					</div>
                    <div class="form-group">
