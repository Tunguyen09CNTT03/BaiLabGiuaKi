...
<html>
<head>
	<title>Thêm/Sửa Danh Mục Chi Nhánh Cửa Hàng</title><style>title{color: red;}</style>
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Thêm/Sửa Danh Mục Chi Nhánh Cửa Hàng</h2>
			</div>
			<div class="panel-body">
				<form method="post">
					<div class="form-group">
					  <label for="name">Tên Chi Nhánh Mới:</label>
